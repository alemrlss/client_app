...
import {
    BsBoxArrowLeft, // Nuevo icono para cerrar el sidebar
    BsBoxArrowRight,
    BsFillHouseLockFill,
    BsFillHousesFill
} from "react-icons/bs";
import { FaWarehouse, FaHospital, FaTags, FaMapMarkedAlt, FaBriefcaseMedical, FaUsers, FaFileAlt } from "react-icons/fa";
...
const Sidebar = () => {
    ...
    const [activeSection, setActiveSection] = useState("inicio"); // Estado para rastrear la sección activa
    ...
    const activeColor = "text-color3 bg-slate-100 rounded-md"; // Define el color activo aquí
    ...
    return (
        <aside
            ...
            <ul className="ml-2 my-4 space-y-4 flex flex-col justify-start">
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "inicio" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
                ...
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "inventario" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
                ...
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "centros_de_salud" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
                ...
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "marcas" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
                ...
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "municipios" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
                ...
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "bajas_tecnicas" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
                ...
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "usuarios" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
                ...
                <li>
                    <div
                        className={`mx-2 p-2 text-lg font-semibold cursor-pointer flex ${activeSection === "reportes" ? `${activeColor} ${hoverActiveColor}` : hoverInactiveColor}`}
